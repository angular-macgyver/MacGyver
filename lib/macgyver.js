        ...
        return function($scope, $element, $attr, controllers) {
          return $attr.$observe("tableSection", function(sectionName) {
            ...
            $scope.$watch("table", function(table) {
              ...
              if (!($attr.models != null) && sectionName === "header") {
...
>>>>>>> Moving models attribute exist on the tableSection directive, adding support for controller on tableSection
...
module.controller("ExampleController", [
  "$scope", "$timeout", "Table", "SectionController", function($scope, $timeout, Table, SectionController) {
    var BodySectionController, headerObject;
    BodySectionController = (function(_super) {

      __extends(BodySectionController, _super);

      function BodySectionController(section) {
      ...
      BodySectionController.prototype.cellValue = function(row, colName) {
        switch (colName) {
          ...
          case "a_and_b":
            return row.model.a + row.model.b;
          default:
            return this.defaultCellValue(row, colName);
        }
      };

      BodySectionController.prototype.state = function(row, colName) {
    ...
    $timeout(function() {
      var columns;
      return $scope.columns = columns = ["name", "a_and_b", "c", "d", "created"];
    }, 5000);
