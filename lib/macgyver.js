  ...
  function() {
    return {
      link: function(scope, element, attributes) {
        ...
        return scope.$watch(attributes.macUploadRoute, function(route) {
          var options;
          if (disabled) {
            return;
          }
          options = {
            ...
            submit: function(event, response) {
              var file, fileType, runExpression, _i, _len, _ref, _ref1, _results;
              runExpression = function() {
                var expression;
                if (attributes.macUploadSubmit != null) {
                  expression = $parse(attributes.macUploadSubmit);
                  return scope.$apply(expression(scope, {
                    $event: event,
                    $response: response
                  }));
                }
              };
              if ((attributes.macUploadPreviews != null) && ((_ref = response.files) != null ? _ref.length : void 0) > 0) {
                _ref1 = response.files;
                _results = [];
                  ...
                  _results.push((function(file) {
                    ...
                    reader.onload = function(event) {
                      if (previews != null) {
                        previews.push({
                          fileName: file.name,
                          src: fileType === "image" ? event.target.result : "/images/file_icon.png",
                          isGeneric: fileType === "generic" ? true : false
                        });
                      }
                      runExpression();
                      return scope.$digest();
