var augmentWidthOrHeight, core_pnum, cssExpand, extendjQuery, getStyles, getWidthOrHeight, getWindow, isScope, isWindow, jqLiteExtend, rnumnonpx;
...
angular.module("Mac").directive("macModal", [
  "$rootScope", "$parse", "modal", "modalViews", "util", function($rootScope, $parse, modal, modalViews, util) {
    return {
      restrict: "E",
      template: "<div class=\"modal-overlay hide\"><div class=\"modal\"><a mac-modal-close=\"mac-modal-close\" class=\"close-modal\"></a><div ng-transclude=\"ng-transclude\" class=\"modal-content-wrapper\"></div></div></div>",
      replace: true,
      transclude: true,
      compile: function(element, attrs, transclude) {
        return function($scope, element, attrs) {
          var opts, registerModal, registeredId;
          ...
          return $scope.$on("$destroy", function() {
            if (registeredId) {
              return modal.unregister(registeredId);
            }
          });
        };
      }
  ...
  "$parse", "$timeout", "keys", "util", function($parse, $timeout, keys, util) {
    return {
      ...
      compile: function(element, attrs) {
        ...
        return function($scope, element, attrs) {
          var equalityCheck, updateAutocompleteSource;
          $scope.textInput = "";
