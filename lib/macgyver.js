  ...
  "$animate", "$compile", "$filter", "$http", "$parse", "$rootScope", "$timeout", "keys", function($animate, $compile, $filter, $http, $parse, $rootScope, $timeout, keys) {
    return {
      ...
      link: function($scope, element, attrs, ctrl, transclude) {
        var $menuScope, appendMenu, autocompleteUrl, clickHandler, currentAutocomplete, delay, disabled, getData, inside, isMenuAppended, labelKey, menuEl, onError, onSelect, onSelectBool, onSuccess, positionMenu, queryData, queryKey, reset, source, timeoutId, updateItem;
          ...
          if (data.length > 0) {
            ...
            $menuScope.items = data.map(function(item) {
              ...
              if (angular.isObject(item)) {
                ...
                if (item.value == null) {
                  item.value = itemGetter(item) || "";
                }
                if (item.label == null) {
                  item.label = itemGetter(item) || "";
                }
                return item;
              } else {
                return {
...
angular.module("Mac").directive("macTableSectionBlankRow", function() {
  ...
  MacTableSectionBlankRowCtrl = (function() {
    ...
    MacTableSectionBlankRowCtrl.prototype.watch = function(expression, sectionName) {
      ...
      return killWatcher = this.scope.$watch("table.sections." + sectionToWaitOn + ".rows", (function(_this) {
...
angular.module("Mac").directive("macTableSectionController", function() {
  ...
  MacTableSectionControllerCtrl = (function() {
    ...
    MacTableSectionControllerCtrl.prototype.watch = function(expression, sectionName) {
      return this.scope.$watch(expression, (function(_this) {
  ...
  "$parse", function($parse) {
    ...
    SelectedModelsController = (function() {
      ...
      SelectedModelsController.prototype.watch = function(expression, sectionName) {
        ...
        this.scope.$watch(expression, (function(_this) {
        ...
        return this.scope.$watch("table.sections." + sectionName + ".rows.length", (function(_this) {
          return function() {
            var range;
