...
angular.module("Mac").directive("macDatepicker", [
  "util", function(util) {
    return {
      ...
      replace: true,
      template: "<div class=\"date-time\"><i class=\"icon-calendar\"></i><input type=\"text\"/></div>",
      compile: function(element, attrs) {
      ...
      compile: function(element, attrs, transclude) {
        ...
        return function($scope, element, attrs) {
          ...
          createHeaderCellTemplate = function(column) {
            var cell, cellClass, contextText, width, _ref;
            if (column == null) {
              column = "";
            }
          ...
          $scope.getColumnCss = function(column) {
            return $scope.columnsCss[column];
          };
          ...
          $scope.drawHeader = function() {
            ...
            if (opts.lockFirstColumn) {
              ...
              _ref1 = createHeaderCellTemplate($scope.columns[0]), cell = _ref1.cell, width = _ref1.width;
          ...
          $scope.drawBody = function() {
            var cell, columnName, data, emptyTemplateRow, endIndex, fcTableRow, i, orderBy, row, tableRow, width, _i, _ref, _ref1, _results;
            data = $scope.data || [];
            ...
            _results = [];
            for (i = _i = 0; 0 <= numDisplayRows ? _i <= numDisplayRows : _i >= numDisplayRows; i = 0 <= numDisplayRows ? ++_i : --_i) {
...
angular.module("Mac").directive("macTime", [
  "util", "keys", "$filter", function(util, keys, $filter) {
    return {
      ...
      replace: true,
      template: "<div class=\"date-time\"><i class=\"icon-time\"></i><input type=\"text\" placeholder=\"--:--\" maxlength=\"8\"/></div>",
      compile: function(element, attrs) {
        var defaults, inputElement, opts;
        defaults = {
          id: "time-input",
