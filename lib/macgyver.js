...
angular.module("Mac").directive("macTable", [
  "$rootScope", "$compile", "$filter", "util", function($rootScope, $compile, $filter, util) {
    return {
      ...
      replace: true,
      transclude: true,
      template: "<div class=\"mac-table-container mac-table\"><div class=\"mac-table-header\"><div class=\"mac-table-row\"></div></div><div class=\"mac-table-body-wrapper\"><div ng-show=\"lockTitleColumn\" class=\"mac-title-column\"><div class=\"mac-table-row\"></div></div><div class=\"mac-table-body\"></div><div class=\"mac-table-body-height\"></div></div><div class=\"mac-table-footer\"><div class=\"mac-table-row custom-footer-row\"></div><div class=\"mac-table-row total-footer-row\"></div></div><div ng-transclude=\"ng-transclude\" ng-cloak=\"ng-cloak\" class=\"mac-table-transclude\"></div></div>",
      compile: function(element, attrs, transclude) {
        var bodyBlock, bodyHeightBlock, bodyWrapperBlock, cellOuterHeight, customFooterRow, defaults, elementHeight, emptyCell, firstColumn, footerBlock, headerBlock, headerRow, opts, totalRow, totalRows, transcludedBlock;
        defaults = {
          hasHeader: true,
        ...
        return function($scope, element, attrs) {
          var bodyColumns, calculateColumnCss, calculateRowCss, createCellTemplate, createHeaderCellTemplate, createRowTemplate, getTemplateCell, reOrderingRows, render, updateDisplayRows;
          bodyColumns = $(".table-body-template .cell", transcludedBlock).map(function(i, item) {
            return $(item).attr("column");
          });
          render = function() {
            var firstColumnName, width, _ref;
          ...
          $scope.drawBody = function() {
            var cell, columnName, data, endIndex, fcTableRow, row, tableRow, width, _ref, _ref1;
            data = $scope.orderedRows || [];
            ...
            if (opts.lockFirstColumn) {
              ...
              fcTableRow.attr({
                "ng-repeat": "row in displayRows",
                "ng-cloak": "ng-cloak"
              }).addClass("{{$index % 2 | boolean:'odd':'even'}}").append(cell);
              $compile(firstColumn)($scope);
              $scope.headerLeftMargin = width;
              return bodyBlock.css({
