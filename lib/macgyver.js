...
angular.module("Mac").directive("macTableView", [
  "$rootScope", "$compile", function($rootScope, $compile) {
    return {
      ...
      replace: true,
      transclude: true,
      template: "<div class=\"table-container\"><div class=\"table-header\"><div class=\"table-row\"></div></div><div class=\"table-body-wrapper\"><div class=\"table-body\"></div><div class=\"table-body-height\"></div></div><div class=\"table-footer\"><div class=\"table-row\"></div></div><div ng-transclude=\"ng-transclude\" ng-cloak=\"ng-cloak\" class=\"table-transclude\"></div></div>",
  ...
  "$rootScope", "$parse", function($rootScope, $parse) {
    return {
      ...
      compile: function(element, attr) {
        var chosenElement, getSelected, noResult, options, placeholder, selectedExp, tagsListName;
        ...
        return function($scope, element, attr) {
          ...
          tagsList = $scope.$parent[tagsListName] || [];
