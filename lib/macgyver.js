...
angular.module("Mac").directive("macModal", [
  "$rootScope", "$parse", "modal", "util", "keys", function($rootScope, $parse, modal, util, keys) {
    return {
      restrict: "E",
      template: "<div ng-click=\"closeOverlay($event)\" class=\"modal-overlay hide\"><div class=\"modal\"><a ng-click=\"closeModal($event)\" class=\"close close-modal\"></a><div ng-transclude=\"ng-transclude\"></div></div></div>",
      replace: true,
      transclude: true,
      link: function($scope, element, attrs) {
