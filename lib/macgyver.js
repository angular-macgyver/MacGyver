...
angular.module("Mac").directive("macModal", [
  "$rootScope", "$parse", "modal", "util", "keys", function($rootScope, $parse, modal, util, keys) {
    return {
      restrict: "E",
      template: "<div ng-click=\"closeOverlay($event)\" class=\"modal-overlay hide\"><div class=\"modal\"><a ng-click=\"closeModal($event)\" class=\"close-modal\"></a><div class=\"modal-content-wrapper\"></div></div></div>",
      replace: true,
      transclude: true,
