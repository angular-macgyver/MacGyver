...
angular.module("Mac").directive("macTagInput", [
  function() {
    return {
      restrict: "E",
      template: "<div class=\"mac-tag-input\"><mac-tag-autocomplete mac-tag-autocomplete-source=\"items\" mac-tag-autocomplete-selected=\"selected\" mac-tag-autocomplete-placeholder=\"placeholder\" class=\"tag-autocomplete\"></mac-tag-autocomplete></div>",
      transclude: true,
      replace: true,
      scope: {
